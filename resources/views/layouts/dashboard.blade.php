...
>
  <head>
    ...
    <title>Dashboard - Harvin Inventaris SMK TTH</title>
    ...
    <link rel="stylesheet" href="{{asset('asset/sneat-1.0.0/assets/vendor/libs/apex-charts/apex-charts.css')}}" />
  ...
  <span class="app-brand-text demo menu-text fw-bolder ms-2 text-capitalize">Harvin</span>
</a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Data Inventaris</span>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('admin.invent')}}" class="menu-link">
                    <div data-i18n="Account">Master Data</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('products.create') }}" class="menu-link">
                    <div data-i18n="Notifications">Tambah Data Inventaris</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="pages-account-settings-connections.html" class="menu-link">
                    <div data-i18n="Connections">Barang Keluar</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Supplier</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('supplier.index') }}" class="menu-link">
                    <div data-i18n="Basic">Data Supplier</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('supplier.create')}}" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Tambah Supplier</div>
                  </a>
                </li>
                <!-- <li class="menu-item">
            ...
            <!-- Cards -->
            <li class="menu-item">
              <a href="{{route('admin.pinj')}}" class="menu-link">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{asset('asset/sneat-1.0.0/assets/img/avatars/1.png')}}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Good Morning, {{ Auth::user()->name }} 🌞</h5>
                          <p class="mb-4">"
                            <span class="fw-bold">Kesuksesan</span> bersumber dari perbuatan. 
                            Orang yang sukses terus melakukan usaha. 
                            Orang sukses bahkan membuat kesalahan, namun mereka tidak berhenti usaha." 
                            - Cobrad Hilton
                          </p>
                      ...
                      <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                          <img
                            src="{{asset('asset/sneat-1.0.0/assets/img/illustrations/man-with-laptop-light.png')}}"
                            height="140"
                            alt="View Badge User"
    ...
    <!-- Vendors JS -->
    <script src="{{asset('asset/sneat-1.0.0/assets/vendor/libs/apex-charts/apexcharts.js')}}"></script>

    <!-- Main JS -->
    <script src="{{asset('asset/sneat-1.0.0/assets/js/main.js')}}"></script>

    <!-- Page JS -->
    <script src="{{asset('asset/sneat-1.0.0/assets/js/dashboards-analytics.js')}}"></script>
